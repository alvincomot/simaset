...
export default function MasterKategori({ role, setRole, onLogout, onNavigate, currentPage }) {
  // Mock Data Kategori Awal (Sesuai contoh)
          ...
          >
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-blue-500 resize-none"
              />
            </div>
            <button
              type="submit"
